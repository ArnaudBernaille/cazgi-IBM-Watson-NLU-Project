...
//Yep it's not safe : 
 const api_key = "QUNg9qQoawlyLjQUfkSy1DSBHWxbk1Xy9w1sNPp_rbIM";
 const api_url = "https://api.us-south.natural-language-understanding.watson.cloud.ibm.com/instances/ef4d659e-ed98-41b2-b037-04d7c5904ce4";

function getNLUInstance() {
    /*Type the code to create the NLU instance and return it.
    You can refer to the image in the instructions document
    to do the same.*/
    console.log(`calling the getNULInstance avec la clef API ${api_key}` )
